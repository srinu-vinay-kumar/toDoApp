...
function ModalBox({ setModelOpen, modelOpen }) {
  return (
    <div
      className="w-[670px] h-[388px] rounded-[10px] flex-col justify-start items-start inline-flex"
      style={{ boxShadow: "0px 0px 8px 0px rgba(54, 89, 226, 0.16)" }}
    >
      {console.log(setModelOpen)}
      <div className="w-[670px] h-[52px] px-6 py-2.5 bg-white border-b border-blue-100 justify-between items-center inline-flex">
        <div className="text-blue-800 text-base font-normal font-['Nunito Sans'] leading-normal gap-[24px]">
          Edit task
          <svg
            width="20"
            height="20"
      ...
      <div className="w-[670px] px-6 py-2.5 bg-white border-t border-blue-100 justify-end items-center gap-2.5 inline-flex">
        <div className="w-[69px] px-2 py-2.5 bg-violet-100 rounded-lg justify-center items-center gap-1 flex">
          <div className="px-2 justify-center items-center gap-2.5 flex">
            <div className="text-sky-600 text-xs font-normal font-['Nunito Sans'] leading-tight">
              Cancel
            </div>
          </div>
        </div>
        <div className="w-[59px] px-2 py-2.5 bg-blue-600 rounded-lg justify-center items-center gap-1 flex">
          <div className="px-2 justify-center items-center gap-2.5 flex">
